/* [Display Settings] */
// View mode: laid out flat on the ground/bed for 3D printing, or fully assembled
view_mode = "print_plate"; // [print_plate, assembled]
...
module print_plate_layout() {
    ...
    // Minimum 6mm clearance between all adjacent pieces.
    ...
    // Safely placed in the wide bays between straight leg shafts
    if (use_locking_pins) {
